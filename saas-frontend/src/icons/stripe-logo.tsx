...
const MemoIcon: React.FC<IconProps> = ({ className, colors = defaultColors, height }) => (
  <svg
    ...
    enableBackground="new 0 0 468 222.5" // Use enableBackground directly as an attribute
    xmlSpace="preserve"
    className={className} height={height} width={(height / base_dimensions.height) * base_dimensions.width}
  >
    <path
      fill={colors.primary}
