...
export default function UI({ practitionerId }: Props) {
  ...
  const { data: paidOrders } = useMyServiceOrders(practitionerId, 'PAID', categoryFilter === 'ALL' ? undefined : categoryFilter);
  const { data: inProgressOrders } = useMyServiceOrders(practitionerId, 'IN_PROGRESS', categoryFilter === 'ALL' ? undefined : categoryFilter);
  const { data: deliveredOrders } = useMyServiceOrders(practitionerId, 'DELIVERED', categoryFilter === 'ALL' ? undefined : categoryFilter);
