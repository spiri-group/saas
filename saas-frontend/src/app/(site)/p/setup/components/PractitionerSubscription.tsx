...
import UsePractitionerSubscriptionPlans from "../hooks/UsePractitionerSubscriptionPlans";
...
const useBL = (props: BLProps) => {
    ...
    const practitionerSubscriptionOptions = UsePractitionerSubscriptionPlans(currency);
    ...
    useEffect(() => {
        if (practitionerSubscriptionOptions.data != null) {
            let data = practitionerSubscriptionOptions.data
    ...
    }, [practitionerSubscriptionOptions.data, selectedPlans, payFrequency, props.control])

    return {
        loading: practitionerSubscriptionOptions.isLoading,
        set: {
...
const PractitionerSubscription: React.FC<Props> = (props) => {
    ...
    return (
        <>
            <div className="flex flex-col" data-testid="practitioner-subscription-section">
                <div className='flex flex-row justify-between mt-3 mb-2'>
                    ...
                    <div className="flex flex-row items-center space-x-6 pr-4" data-testid="practitioner-base-plan-price">
                                            ...
                                            <>
                                                {bl.data.addOns.map((option) => {
                                                    ...
                                                    <div
                                                        ...
                                                        key={option.id}
                                                        data-testid={`practitioner-addon-plan-${option.name.toLowerCase().replace(/\s+/g, '-')}`}
...
export default PractitionerSubscription;
