...
import tour_reasons from "./_hooks/tour_reasons.json"
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    ...
                                    placeholder="Tour Refund Policy Title"
                                    {...field}
                                    />
                            </FormControl>
                        </FormItem>
                ...
                <FormField
                    ...
                    render={({ field }) => {
                        ...
                        <FormItem className="space-y-2">
                            <FormLabel>Tours from Country</FormLabel>
                            <FormControl>
                                { countries.length == 1
...
const UpsertTourRefundPolicies: React.FC<Props> = (props) => {
    ...
    if (options.countries.length === 0) {
        ...
        return (
            <div className="flex flex-col gap-4 p-4">
                <h3 className="font-semibold">No Tour Locations Available</h3>
                <p>Locations where you offer tours are required to setup refund policies. Please navigate to and enter your locations.</p>
...
export default UpsertTourRefundPolicies;
