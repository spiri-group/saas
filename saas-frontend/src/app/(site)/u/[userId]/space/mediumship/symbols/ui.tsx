...
import usePersonalSymbols, { PersonalSymbol } from '../hooks/usePersonalSymbols';
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {symbolsNeedingMeaning.slice(0, 5).map(s => (
                        ...
                        >
                          {s.symbolName} ({s.totalOccurrences}×)
                        </button>
                      ))}
                    </div>
                  </div>
            ...
            <div className="flex flex-wrap gap-6 mb-8 text-sm">
              ...
              {topSymbols[0] && topSymbols[0].totalOccurrences > 1 && (
                <div className="flex items-center gap-2 text-slate-400">
                  ...
                  <span>Most common: <strong className="text-white">{topSymbols[0].symbolName}</strong> ({topSymbols[0].totalOccurrences}×)</span>
                </div>
              )}
            </div>
